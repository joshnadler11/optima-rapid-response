...
const PriceBeatBanner = () => {
  ...
  return (
    <section ref={ref} className="py-16 md:py-20 bg-primary overflow-hidden">
      <div className="container">
        ...
        >
          {/* Shield with spring bounce */}
          <div
            style={{
              transform: visible ? 'scale(1)' : 'scale(0.3)',
              opacity: visible ? 1 : 0,
              transition: 'transform 0.6s cubic-bezier(0.34,1.56,0.64,1) 0.1s, opacity 0.4s ease-out 0.1s',
            }}
          >
              ...
              {words.map((word, i) => (
                <span
                  ...
                  style={{
                    ...
                    transition: `opacity 0.3s ease-out ${0.2 + i * 0.05}s, transform 0.3s ease-out ${0.2 + i * 0.05}s`,
                  }}
                >
                  {word}
                </span>
