...
function Shield() {
  ...
  return (
    <mesh ref={ref} geometry={geometry} material={mat} position={[3.5, 0, -2]}>
      {/* Orange rim light positioned behind the shield */}
    </mesh>
  );
}
...
function SceneContent() {
  return (
    <>
      ...
      {/* Orange rim/back light for shield edge glow */}
      <pointLight position={[5.5, 1, -3]} intensity={1.5} color="#E85D24" distance={8} decay={2} />
